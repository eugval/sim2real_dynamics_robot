...
class SawyerEEFVelocityController(object):
    ...
    def __init__(self, urdf_relative_path ='../../assets/urdf/sawyer_arm_intera.urdf' ):
        '''
        ...
        self.num_joints = 7
        # Get the URDF
        urdf_path=os.path.join(os.path.dirname(os.path.realpath(__file__)),urdf_relative_path)
    ...
    def compute_joint_velocities_for_endpoint_velocity(self, endpoint_velocity_in_base_frame, joint_angles_array):
        ...
        :param endpoint_velocity_in_base_frame: end-effector velocity command
        :param joint_angles_array: Current joint angles
        :return: joint velocity commands
        '''
