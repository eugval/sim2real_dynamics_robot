...
Taken from the robosuite package :  https://github.com/StanfordVL/robosuite
Paper reference: Fan et al ,  SURREAL: Open-Source Reinforcement Learning Framework and Robot Manipulation Benchmark, Conference on Robot Learning 2018
