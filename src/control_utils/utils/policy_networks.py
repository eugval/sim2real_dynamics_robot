...
class PPO_PolicyNetwork(PolicyNetworkBase):
    def __init__(self, state_space, action_space, hidden_dim, action_range=1., init_w=3e-3, log_std_min=-20, log_std_max=2):
        super(PPO_PolicyNetwork,self).__init__(state_space, action_space, action_range)
...
class DPG_PolicyNetwork(PolicyNetworkBase):
    def __init__(self, state_space, action_space, hidden_dim, action_range=1., init_w=3e-3):
        super(DPG_PolicyNetwork,self).__init__(state_space, action_space, action_range)
...
class DPG_PolicyNetworkLSTM(PolicyNetworkBase):
    def __init__(self, state_space, action_space, hidden_dim, action_range=1., init_w=3e-3):
        super(DPG_PolicyNetworkLSTM,self).__init__(state_space, action_space, action_range)
...
class SAC_PolicyNetwork(PolicyNetworkBase):
    def __init__(self, state_space, action_space, hidden_size, action_range=1., init_w=3e-3, log_std_min=-20, log_std_max=2):
        super(SAC_PolicyNetwork,self).__init__(state_space, action_space, action_range=action_range)
...
class SAC_PolicyNetworkLSTM(PolicyNetworkBase):
    def __init__(self, state_space, action_space, hidden_size, action_range=1., init_w=3e-3, log_std_min=-20, log_std_max=2):
        super(SAC_PolicyNetworkLSTM,self).__init__(state_space, action_space, action_range=action_range)
...
class PredictionNetwork(BaseNetwork):
    ...
    def __init__(self, input_dim, output_dim, hidden_dim):
        super(PredictionNetwork,self).__init__(input_dim, output_dim, hidden_dim)
        self.linear1 = nn.Linear(input_dim, hidden_dim)
        self.linear2 = nn.Linear(hidden_dim, hidden_dim)
        self.linear3 = nn.Linear(hidden_dim, hidden_dim)
...
class EmbedNetwork(BaseNetwork):
    ...
    def __init__(self, input_dim, output_dim, hidden_dim):
        super(EmbedNetwork,self).__init__(input_dim, output_dim, hidden_dim)
        self.linear1 = nn.Linear(input_dim, hidden_dim)
        self.linear2 = nn.Linear(hidden_dim, hidden_dim)
